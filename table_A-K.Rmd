...
cat("Number of records with zero discards in table C", sep="\n")
table_A2 |> filter(is.na(C_DISCARDS)) |> count() |> flextable::flextable()
...
table_A2 |> count(YEAR, DOMAIN_DISCARDS) |> filter(DOMAIN_DISCARDS == "NK") |> flextable::flextable() |> flextable::autofit() |>
  flextable::colformat_num(j="YEAR", big.mark="")
...
cat("Number of records with zero discards in table C", sep="\n")
table_A2 |> filter(is.na(D_DISCARDS)) |> count() |> flextable::flextable()
...
cat("Number of records with zero discards in table C", sep="\n")
table_A2 |> filter(is.na(E_TOTWGHTLANDG)) |> count() |> flextable::flextable()

# discard records with no discards
table_A2 <- table_A2 |> mutate(DOMAIN_LANDINGS = case_when(
                            is.na(E_TOTWGHTLANDG) ~ "NK",
                            .default = as.character(DOMAIN_LANDINGS)
))

# check all DOMAIN_DISCADS
table_A2 |> count(YEAR, DOMAIN_LANDINGS) |> filter(DOMAIN_LANDINGS == "NK") |> flextable::flextable() |> flextable::autofit() |>
  flextable::colformat_num(j="YEAR", big.mark="")
...
cat("Number of records with zero discards in table C", sep="\n")
table_A2 |> filter(is.na(F_TOTWGHTLANDG)) |> count() |> flextable::flextable()

# discard records with no discards
table_A2 <- table_A2 |> mutate(DOMAIN_LANDINGS = case_when(
                            is.na(F_TOTWGHTLANDG) ~ "NK",
                            .default = as.character(DOMAIN_LANDINGS)
))
