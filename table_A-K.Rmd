...
pacman::p_load(tidyverse, here, patchwork, RPostgres, openxlsx, arsenal, daff)
...
sas |> count(YEAR, VESSEL_LENGTH) |> mutate(VESSEL_LENGTH = factor(VESSEL_LENGTH)) |>
  ...
  flextable::flextable() |> theme_zebra() |>
...
# akt1_all2  |> count(YEAR, VESSEL_LENGTH) |> pivot_wider(names_from = VESSEL_LENGTH, values_from=n) |> flextable::flextable() |> flextable::set_caption("Vessel lengths from capacity")
