...
ft <- table_F |> head(n=20) |> flextable::flextable() |>
  flextable::autofit() |>
  flextable::theme_zebra() |>
  flextable::colformat_num(j = "YEAR", big.mark = "")
...
# Write the resulting table A into der folder as rds file and into results folder
saveRDS(table_F, file = file.path(path_der,"table_F.rds"))
...
table_A2 <- table_A2 |>
  ...
  left_join(table_F |> select(YEAR, COUNTRY, DOMAIN_LANDINGS, SPECIES, F_TOTWGHTLANDG=TOTWGHTLANDG) |>  distinct(), 
            by=join_by(YEAR, COUNTRY, DOMAIN_LANDINGS, SPECIES))
