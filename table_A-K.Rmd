...
pacman::p_load(tidyverse, here, patchwork, RPostgres, openxlsx, arsenal)
...
## fall back - use last years data
last_path <- here::here("der", run.year-1) 
IC_DB <- readRDS(file.path(last_path, "IC_DB.rds"))
