...
# load sas data
# NEW FILE HERE ####
sas <- readRDS(file = file.path(gsub("2026", "2025",path_der),"logbook_2013_15.rds")) |>
...
# TO DO !!! ####
# fix vessel length categories first here ####
...
### Cleaning data against capacty table
