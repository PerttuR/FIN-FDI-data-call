...
j <- rbind(j_monthly, j_not_monthly)

## split sas data away and check if it needs more cleaning
j_13_15 <- j |> filter(YEAR %in% c(2013, 2014, 2015))
j_16_25 <- j |> filter(!YEAR %in% c(2013, 2014, 2015))
