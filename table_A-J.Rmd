...
j11 <- j10 |> mutate(FISHING_TECH = case_when(
  ANNUAL_FISHINGTRIPS == 0 ~"INACTIVE",
  TRUE ~ FISHING_TECH
))


# Put the variables in the correct order:
table_J <- j11 |> select(COUNTRY, YEAR, VESSEL_LENGTH, FISHING_TECH, SUPRA_REGION, GEO_INDICATOR, PRINCIPAL_SUB_REGION, TOTTRIPS=ANNUAL_FISHINGTRIPS, TOTKW, TOTGT, TOTVES, AVGAGE, AVGLOA, MAXSEADAYS)
