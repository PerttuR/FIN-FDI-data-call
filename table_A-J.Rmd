...
table_A2 <- table_A2 |>
  ...
  left_join(table_C |> select(YEAR, DOMAIN_DISCARDS, SPECIES, C_DISCARDS=DISCARDS), 
            by=join_by(YEAR, DOMAIN_DISCARDS, SPECIES))
...
table_A2 <- table_A2 |>
  # select(YEAR, DOMAIN_DISCARDS, SPECIES, TOTWGHTLANDG, TOTVALLANDG) |> # testing only
  left_join(table_D |> select(YEAR, DOMAIN_DISCARDS, SPECIES, D_DISCARDS=DISCARDS), 
            by=join_by(YEAR, DOMAIN_DISCARDS, SPECIES))
...
table_A2 <- table_A2 |>
  ...
  left_join(table_E |> select(YEAR, DOMAIN_LANDINGS, SPECIES, E_TOTWGHTLANDG=TOTWGHTLANDG) |>  # distinct(), 
            by=join_by(YEAR, DOMAIN_LANDINGS, SPECIES))
...
table_A2 <- table_A2 |>
  #select(YEAR, DOMAIN_LANDINGS, SPECIES, TOTWGHTLANDG, TOTVALLANDG) |> # testing only
  left_join(table_F |> select(YEAR, DOMAIN_LANDINGS, SPECIES, F_TOTWGHTLANDG=TOTWGHTLANDG) |>  distinct(), 
            by=join_by(YEAR, DOMAIN_LANDINGS, SPECIES))
