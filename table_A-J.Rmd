...
j_all <- j3 |>
          ...
          #mutate(
          #    FISHING_TECH = if (n() > 1) "PMP" else FISHING_TECH
          #  ) |>
          slice(1) |>
          ungroup()
...
# testing
# j6b |> select(COUNTRY, YEAR, VESSEL_LENGTH, FISHING_TECH, PRINCIPAL_SUB_REGION, ULKOINENTUNNUS, ANNUAL_FISHINGDAYS, ANNUAL_FISHINGTRIPS) |> filter(VESSEL_LENGTH == "VL40XX") |> View()
