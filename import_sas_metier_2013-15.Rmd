...
pacman::p_load(tidyverse, here, patchwork, RPostgres, openxlsx, janitor)
...
metier_2013_15 <- read.dbTable(schema="2025-04-10-dcprod", table="metier_sas_files_2013_15", dbname = "kake_siirto")
...
* TO DO: do we need to use the cleaned SAS data for table H ???